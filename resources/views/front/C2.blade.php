...
@php
    $array = ['patter-925X1130', 'patter-925X850', 'patter-925X550', 'patter-925X1130', 'patter-925X850', 'patter-1860X550'];
@endphp
...
@section('version')
    <div class="container-pc container-pc-c2">
        @foreach ($activities as $index => $item)
            <div data-aos="custom-animation-up" class="c{{ $index + 1 }} {{ $item->img_size_pad }} ">
