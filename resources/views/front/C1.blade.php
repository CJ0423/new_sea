...
@section('version')
    <div class="container-pc container-pc-c1">
        ...
        <div data-aos="custom-animation-up" class="c5 row-img">
            <figure class="main-img a1-5" style="background-image: url('{{ asset('img/mainImg/a1/4-4.png') }}');">
                <figcaption>
                    <h2>主標題文字5</h2>
                    <h3>副標題文字5</h3>
                    <a href="link-to-purchase-page" class="buy-now-button">按鍵名稱</a>
        ...
        <div data-aos="custom-animation-up" class="c6 column-img">
            <figure class="main-img a1-6" style="background-image: url('{{ asset('img/mainImg/a1/2-2.png') }}');">
                <figcaption>
                    <h2>主標題文字6</h2>
                    <h3>副標題文字6</h3>
                    <a href="link-to-purchase-page" class="buy-now-button">按鍵名稱</a>
